...
export default function MultiPlayerGame() {
    ...
    ws.onmessage = (e) => {
      ...
      switch (msg.type) {
        ...
        case "bubble_popped":
          ...
          if (activeBubble?.id === msg.bubbleId) {
        ...
        case "bubble_gone":
          // We tried to answer but bubble was already taken
          setActiveBubble(null);
          setAnswered(null);
          break;
  ...
  }, [phase, myId, activeBubble, bubbles]);
  ...
  function handleAnswer(choice: string) {
    ...
    // Optimistic: if correct, server will send bubble_popped
    // If wrong, server will send answer_wrong
